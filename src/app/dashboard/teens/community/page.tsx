...
export default function CommunityPage() {
  return (
    <div className="w-full h-full flex flex-col gap-4">
      ...
      <div className="mb-4 rounded-xl bg-gradient-to-r from-teal-600 to-teal-700 px-6 py-4 flex justify-center items-center shadow-lg relative overflow-hidden">
        ...
        <div className="flex items-center relative z-10">
          <div className="bg-teal-500 p-3 rounded-full mr-4 shadow-inner">
      ...
      <div className="mt-4 flex justify-center mb-10">
        <Link href="/dashboard/teens" className="bg-gradient-to-r from-teal-500 to-teal-600 text-white pl-4 pr-5 py-3 rounded-full flex items-center gap-2 transition-all transform hover:scale-105 border border-teal-400 shadow-md">
          <ArrowLeft size={20} />
