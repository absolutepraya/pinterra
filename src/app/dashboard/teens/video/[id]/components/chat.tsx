          ...
          <div className="flex justify-start">
            <div className="bg-gray-100 border border-gray-200 rounded-lg rounded-tl-none p-4 w-[80%]">
              <div className="flex items-center space-x-2 mb-3">
                <div className="h-6 w-6 bg-gray-300 rounded-full animate-pulse min-w-[24px]"></div>
                <div className="h-4 bg-gray-300 rounded-full w-24 animate-pulse min-w-[96px]"></div>
              </div>
              <div className="space-y-2">
                <div className="h-4 bg-gray-300 rounded-full w-3/4 animate-pulse min-w-[150px]"></div>
                <div className="h-4 bg-gray-300 rounded-full w-1/2 animate-pulse min-w-[100px]"></div>
                <div className="h-4 bg-gray-300 rounded-full w-5/6 animate-pulse min-w-[170px]"></div>
                <div className="h-4 bg-gray-300 rounded-full w-2/3 animate-pulse min-w-[130px]"></div>
              </div>
              {imageUrl && (
                <div className="mt-3 h-32 bg-gray-300 rounded-md w-3/4 animate-pulse flex items-center justify-center min-h-[128px] min-w-[200px]">
